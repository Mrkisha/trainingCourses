			...
			<div class="widget">
				...
				<fieldset class="step" id="second">
				 ...
				 <fieldset class="step" id="third">
					...
					<div class="rowElem">
						...
						<div class="formRight">
							<input type="text" id="s1" value="1" name="productQuantity" /></div>
						<div class="fix"></div>
					</div>
					...
					<div class="rowElem">
						...
						<div class="formRight">
							<input type="text" id="s3" name="productPrice" /></div>
							<div class="fix"></div>
						<div class="fix"></div>
					</div>
				...
				<fieldset class="step" id="anotherCourse">
					...
					<div class="rowElem">
						<label>Item Code:<span class="req">*</span></label>
						<div class="formRight">
							<input type="text" name="productCode2" />
						</div>
						<div class="fix"></div>
					</div>
					...
					<div class="rowElem">
						<label>Item Quantity:<span class="req">*</span></label>
						<div class="formRight">
							<input type="text" id="s1_2" value="1" name="productQuantity2" /></div>
						<div class="fix"></div>
					</div>
					...
					<div class="rowElem">
						<label>Item Price:<span class="req">*</span></label>
						<div class="formRight">
							<input type="text" id="s3_2" name="productPrice2" /></div>
							<div class="fix"></div>
						<div class="fix"></div>
					</div>
				 ...
				 <fieldset class="step" id="fourth">
					...
					<div class="rowElem">
						...
						<div class="formRight">
							<input type="text" readonly="readonly" value="orderTotal" name="orderTotal"/>
						</div>
						<div class="fix"></div>
					</div>
					...
					<div class="rowElem">
						...
						<div class="formRight">
							<input type="text" readonly="readonly" value="orderTax" name="orderTax"/>
						</div>
						<div class="fix"></div>
					</div>
