...
<title>Training - Standards</title>
...
<div class="wrapper">
    ...
    <div class="leftNav">
    	<ul id="menu">
            ...
            <li class="tables"><a href="tables.html" title="" class="active"><span>Standards</span></a></li>
	...
	<!-- Content -->
    <div class="content">
    	<div class="title"><h5>Training Standards</h5></div>

        <?php
        // Get the number of Standards that need to be sent
        $sql = "SELECT * FROM `mod_foxycart_training_tasks` WHERE `task`=2 AND `status`=0";
        ...
        <div class="stats">
        	<ul>
            	<li><a href="#" class="count grey" title="">0</a><span>new pending tasks</span></li>   
        ...
        <div class="widget first">
            <div class="head"><h5 class="iFrames">Standards to be sent</h5></div>
            <table cellpadding="0" cellspacing="0" width="100%" class="tableStatic">
                ...
                <tdbody>
                    ...
                    while($row = mysql_fetch_array($result)) {
                        ...
                        $sql_products = "SELECT * FROM `mod_foxycart_products` WHERE `productCategory` = 'standards' AND `orderId`=".$orderId;
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        <input type="button" value="+ Sent" class="blueBtn">
                    </td>
                </tr>
                <tr>
                    <td>
