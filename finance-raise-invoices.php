	...
	$(document).ready(function($) {
		...
		*/
		...
		$(".invoiceBtn").live("click", function(){
			...
			$.post("API/update-finance-task.php", {orderID: orderid, inputtext: $('input[name="inputtext"]').val()}, function(data_task){
				console.log(data_task);
				toBeRemoved.remove();
				$(".fc_details tfoot").append("<tr><td colspan='2'>Invoice Number:</td><td colspan='2'>" + data_task + "</td></tr>");

				add_class_to_row.removeClass("gradeA").addClass("taskCompleted");
